...
import chinInfoImage from '../assets/image/chin_info.png';
                ...
                <div style={styles.dialogOverlay}>
                    <div style={styles.dialogContent}>
                        ...
                        <div style={styles.instructionSection}>
                            <img src={chinInfoImage} alt="측정 이미지" style={styles.chinImage} />
                        </div>
                        ...
                        <div style={styles.instructionSection}>
                            ...
                            <img src={faceImage} alt="코 길이 측정 참조 이미지" style={styles.faceImage} />
                        </div>

                        <div style={styles.buttonContainer}>
                            <button onClick={handleSubmit} style={styles.closeButton}>
                                확인
                            </button>
